...
func Test_TestCmd_Main(t *testing.T) {
	r := require.New(t)
...
func Test_TestCmd_Main_SubCommand(t *testing.T) {
	r := require.New(t)
...
func Test_TestCmd_Main_SubCommand_err(t *testing.T) {
	r := require.New(t)
...
func Test_TestCmd_Main_BeforeTesters(t *testing.T) {
	r := require.New(t)
...
func Test_TestCmd_Main_BeforeTesters_err(t *testing.T) {
	r := require.New(t)
...
func Test_TestCmd_Main_AfterTesters(t *testing.T) {
	r := require.New(t)
...
func Test_TestCmd_Main_AfterTesters_err(t *testing.T) {
	r := require.New(t)
